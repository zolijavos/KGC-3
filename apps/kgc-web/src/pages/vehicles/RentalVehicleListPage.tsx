      ...
      <div className="kgc-card-bg rounded-lg border border-gray-200 p-12 dark:border-gray-700">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">
            Bérgép járművek modul
          </h3>
          <p className="mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
            A bérgép járművek (utánfutók, aggregátorok, platformok) nyilvántartása hamarosan
            elérhető lesz. A modul ADR-027 alapján készül.
          </p>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="kgc-card-bg rounded-lg border border-gray-200 p-5 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white">Forgalmi nyilvántartás</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Rendszám, típus, dokumentumok
              </p>
            </div>
          </div>
        </div>
        <div className="kgc-card-bg rounded-lg border border-gray-200 p-5 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white">Lejárat emlékeztetők</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400">Műszaki, forgalmi lejárat</p>
            </div>
          </div>
        </div>
        <div className="kgc-card-bg rounded-lg border border-gray-200 p-5 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white">Bérlés kapcsolat</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400">Bérgép modulhoz kötés</p>
            </div>
          </div>
        </div>
      </div>
