...
export function HorillaHRPage() {
  ...
  const openInNewTab = () => {
    window.open(HORILLA_URL, '_blank', 'noopener,noreferrer');
  };
    ...
    <div className="flex h-[calc(100vh-64px)] flex-col">
      ...
      <div className="flex items-center justify-between border-b p-4 kgc-card-bg dark:border-slate-700">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-purple-500 text-white font-bold">
            HR
          </div>
          <div>
        ...
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-white dark:bg-slate-900 z-10">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Horilla HR betöltése...</p>
            </div>
          </div>
        )}
